...
reg_mage5 = FireMage(name='mage5', sp=945, crit=30, hit=16, fullt2=False)
...
reg_mage4.smart_scorch(combustion=10)
reg_mage5.smart_scorch(combustion=10)

sim = Simulation(env=FireEnvironment, mages=[reg_mage1, reg_mage2, reg_mage3, reg_mage4, reg_mage5])
